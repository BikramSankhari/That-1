...
class UserControllerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                ...
                request_serializer=user__pb2.UserWithPassword.SerializeToString,
                response_deserializer=user__pb2.User.FromString,
                _registered_method=True)
...
def add_UserControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=user__pb2.UserWithPassword.FromString,
                    response_serializer=user__pb2.User.SerializeToString,
            ),
...
class UserController(object):
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/user.UserController/Create',
            user__pb2.UserWithPassword.SerializeToString,
            user__pb2.User.FromString,
            options,
            channel_credentials,
            insecure,
